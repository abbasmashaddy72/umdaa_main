<div>
    <div class="grid-cols-3 gap-2 sm:grid">
        ...
        <x-simple-select name="selectedState" id="selectedState" label="State" wire:model="selectedState"
            :options="$states" value-field='id' text-field='name' placeholder="Select State"
            search-input-placeholder="Search State" :searchable="true" />
    </div>
</div>
